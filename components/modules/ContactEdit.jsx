      ...
      <Container maxWidth="md">
        <Box sx={{ py: 1, mb: 1 }}>
          ...
          >
            ...
            <Box sx={{ width: '7ch', mx: 3 }}>
              <Typography sx={{ fontSize: '14px' }}>تماس</Typography>
            </Box>
            <TextField
              size="small"
          ...
          >
            ...
            <Box sx={{ width: '7ch', mx: 3 }}>
              <Typography sx={{ fontSize: '14px' }}>ایمیل</Typography>
            </Box>
            <TextField
              size="small"
          ...
          {/* Instagram Section */}
          <Box
            sx={{ mt: 1, '& .MuiTextField-root': { width: '25ch' } }}
            display="flex"
            alignItems="center"
            align="center"
          >
            ...
            <Box sx={{ width: '7ch', mx: 3 }}>
              <Typography sx={{ fontSize: '14px' }}>اینستاگرام</Typography>
            </Box>
            <TextField
              size="small"
              label="مثال:karbakar"
