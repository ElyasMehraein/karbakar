  ...
  useEffect(() => {
    ...
    if (businessName.length && !englishLetters.test(businessName)) {
      ...
      setSnackbarErrorMessage(
        'برای نام کسب و کار تنها از حروف کوچک و بزرگ انگلیسی بدون فاصله و نقطه استفاده نمایید'
      )
    }
  }, [businessName])
    ...
    <>
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Button
            sx={buttonSx}
            onClick={() => createThisBusiness(businessName, guildName)}
            variant="contained"
          >
            ایجاد کسب و کار
          </Button>
