...
export default function TableBusiness2({ business }) {
  ...
  // ];
  const rows = [
    { name: "Customer X", code: "Widget A", population: "100 units", size: 50 },
    { name: "Customer Y", code: "Gear B", population: "25 boxes", size: 12 },
    { name: "Customer Z", code: "Screw C", population: "500 pieces", size: 200 },
