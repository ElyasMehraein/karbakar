...
export default function Wellcome() {
  ...
  const [SMSOtpTextFieldErrorMessage, setSMSOtpTextFieldErrorMessage] = useState(
    'کد پیامکی بدرستی وارد نشده است'
  )
  ...
  return (
    <div className={styles.container}>
      <div className={styles.wellcomeLogoDiv}>
        <Image className={styles.image} fill priority src={hands} alt="karbakar website logo" />
      </div>
      <h1 className={styles.title}>کارباکار</h1>

      {show ? (
        <div className={styles.wellcomeHeader}>
          <h2 className={styles.aitch2}>
            اتحاد تولیدکنندگانِ آزاد <br />
            برای بخشش محصولات و خدمات به یکدیگر
          </h2>
