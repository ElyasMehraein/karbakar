...
export default function Union({
  ...
  const userIsABusinessAgent = user?.businesses?.some(
    (business) => Number(business.agentCode) === Number(user.code)
  );
  ...
  const categoryText = {
    ...
    category2:
      'اتحادهایی که شما عضو هستید اما هنوز نیازها و پیشنهادهای آن کامل نشده است',
    category3:
  ...
  return (
    <React.Fragment>
      ...
      <JoinAUnion
        {...{ primeBusiness, user, union, MembershipOpen, dialogCloseHandler }}
      />
      <Accordion
        disableGutters
