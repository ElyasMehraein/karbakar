        ...
        >
          <CardHeader
            ...
            avatar={
              <Box sx={{ ml: 1, width: 40, height: 40 }}>
                <ItsAvatar
                  isAvatar={report.providerBusiness?.isAvatar}
                  userCodeOrBusinessBrand={report.providerBusiness?.businessName}
                />
              </Box>
            }
          ...
          <CardHeader
            ...
            avatar={
              <Box sx={{ ml: 1, width: 40, height: 40 }}>
                <ItsAvatar
                  isAvatar={report.receiverBusiness?.isAvatar}
                  userCodeOrBusinessBrand={report.receiverBusiness?.businessName}
                />
              </Box>
            }
