              ...
              <CardActionArea onClick={() => router.push(`/${bill.from.businessName}`)}>
                <CardHeader
                  avatar={
                    <Box sx={{ ml: 1 }}>
                      <ItsAvatar
                        isAvatar={bill.from.isAvatar}
                        userCodeOrBusinessBrand={bill.from.businessName}
                      />
                    </Box>
                  }
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            این عمل غیر قابل بازگشت است و تایید شما به معنی تایید کمیت و کیفیت و رضایت شما از
            محصولات دریافتی است
          </DialogContentText>
        </DialogContent>
        <DialogActions>
