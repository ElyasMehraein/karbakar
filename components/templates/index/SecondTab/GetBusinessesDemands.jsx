...
export default function GetBusinessesDemands() {
  ...
  return (
    <Container maxWidth="md">
      <AccordionServise expand={true}>{SecondTabGuestText()}</AccordionServise>
      <Box
        sx={{
          width: '100%',
          my: 3,
      ...
      >
        {Object.keys(businesses).length ? (
          Object.entries(businesses).map(
            ([guildId, { guildName, jobCategory, businesses: businessList }]) => (
                ...
                {businessList.map(business => (
                  ...
                  >
                    ...
                    <AccordionDetails sx={{ width: '100%' }}>
                      {business.demandsForGuilds.map(guild => guild.requestText).join(', ') ||
