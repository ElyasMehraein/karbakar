...
export const FirtstTabText = () => {
    ...
    return <Box sx={{ py: 1, textAlign: "center" }}>
        ...
        <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
        <Typography sx={{ mb: 1, fontSize: 14 }}>
            نماینده های کسب و کارهایی که به محصولات آنها نیاز دارید درخواست شما را می توانند ببینند و صفحه کسب و کار شما را ملاحظه نمایند
        </Typography>
        <Typography sx={{ mb: 1, fontSize: 14 }}>
            کارباکار بر این اصل استوار است که تولید کننده ها به هر کسی که بخواهند می توانند محصول خود را ارئه نمایند لذا با توجه به محدودیت محصولاتی که دارند
            آنها عنوان شغل و مقدار و نوع محصولاتی که متقاضیان به دیگران ارائه داده اند را بررسی کرده و در مورد اینکه بعنوان دریافت کننده محصول آنها انتخاب شوند تصمیم می گیرند
        </Typography>
        <Typography>
            لذا تا زمانی که ارزشی تولید نکنید و یا محصول یا خدماتی به دیگر اعضا ارائه ننمایید شانس کمی برای دریافت محصولات از اعضا خواهید داشت
        </Typography>
    </Box>
}
export const FirtstTabText2 = () => {
    ...
    return <Box sx={{ py: 1, textAlign: "center" }}>
        <Typography sx={{ mb: 1, fontSize: 14 }}>
            👇کسب و کارهایی که به ارائه محصول به کسب و کار شما متعهد می شوند در این قسمت به نمایش در می آیند
        </Typography>
        <Typography sx={{ mb: 1, fontSize: 14 }}>
