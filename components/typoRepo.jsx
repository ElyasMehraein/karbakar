...
export const firtsEnterText = () => {
    ...
    return <Box sx={{ py: 1, textAlign: "center" }}>
        ...
        <Typography>
        👉   از طریق آیتم های موجود در منوی سمت راست 
        </Typography>
        <Typography>برای ارائه و دریافت کالا و خدمات کسب و کار خود را بسازید
        </Typography>
        <Typography>یا اگر خودتان کسب و کاری و تخصصی ندارید می توانید کسب و کارهای دیگر را بر اساس فاصله خود با آنها در لیست کسب و کارها
        </Typography>
        <Typography>
           و یا اگر اسم آنها را می دانید آن را در بخش جستجوی بالای سایت جستجو کنید 👆

        </Typography>
        <Typography>کسب و کارها راههای تماس خود را در صفحه کسب و کار اعلام می نمایند و شما می توانید برای استخدام شدن با آنها تماس بگیرید
        </Typography>
        <Typography>اگر هیچ کسب و کار خوبی پیدا نکردید با کاریابی تماس بگیرید</Typography>
    </Box>
}
