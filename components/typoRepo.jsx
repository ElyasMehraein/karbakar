...
export const firtsEnterText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      ...
      <Typography sx={{ mb: 1 }}>👉در منوی سمت راست یک کسب و کار جدید بسازید</Typography>
      ...
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
      <Typography>کسب و کارها راههای تماس خود را در صفحه کسب و کار اعلام می کنند</Typography>
      <Typography sx={{ mb: 1 }}>
        و شما می توانید برای استخدام شدن با آنها تماس بگیرید و هماهنگ نمایید
      </Typography>
      <Typography>
        اگر کسب و کار مد نظر خود را پیدا نکردید کاریابی ها را در بخش جستجو پیدا کنید و از آنها کمک
        بگیرید✌
      </Typography>
    </Box>
  )
...
export const SecondTabText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      ...
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        با زدن روی هر کسب و کار وارد صفحه آن کسب و کار می شوید و می توانید آنها را بعنوان دریافت
        کننده خود انتخاب کنید
      </Typography>
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
      <Typography sx={{ fontSize: 14 }}>
        با زدن دکمه تغییر ظرفیت تولید👇 مقدار محصولی که می خواهید ماهانه به آنها ارائه دهید را مشخص
        نمایید
      </Typography>
    </Box>
  )
...
export const thirdTabText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        ساخت یک اتحاد با ثبت نیاز یک کسب و کار به مقداری مشخص از محصولات و خدمات یک یا چند صنف و
        زمان مشخص شروع می شود{' '}
      </Typography>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
      ...
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
      <Typography sx={{ fontSize: 14 }}>
        صنفی که به محصولات آن نیاز دارید باید از قبل وجود داشته باشد و همه اعضا باید یکدیگر را تایید
        کنند
      </Typography>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        کسب و کارها با عضویت در اتحاد تمام اعضای قبلی را تایید می نمایند و اعضای قبلی نیز با رای
        دادن به عضو جدید می توانند با آن متحد شوند
      </Typography>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
...
export const billText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      ...
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
      <Typography sx={{ fontSize: 14 }}>
        زمانی که صورتحساب تایید می شود محصولات ارائه شده در جدولی در کسب و کار تامین کننده نمایش
        داده می شود
      </Typography>
      <Typography sx={{ fontSize: 14 }}>
        البته در صفحه کسب و کار دریافت کننده جهت حفظ حریم شخصی بدون ذخیره و نمایش نام محصول ثبت می
        شود
      </Typography>
      <Typography sx={{ fontSize: 14 }}>
        بطور مثال بجای 100 عدد صندلی پلاستیکی برند فلان از فلان کسب و کار نوشته می شود 100 عدد محصول
        از صنف فروش لوازم خانگی
      </Typography>
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
...
export const FirtstTabText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        با زدن دکمه اعلام نیاز👇 هر چیزی که برای خود یا کسب و کارخود نیاز دارید اعلام کنید
      </Typography>
      <Divider sx={{ width: '50%', mx: 'auto', my: 1, borderBottomWidth: '2px' }} />
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        نماینده های کسب و کارهایی که به محصولات آنها نیاز دارید درخواست شما را می توانند ببینند و
        صفحه کسب و کار شما را ملاحظه نمایند
      </Typography>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        کارباکار بر این اصل استوار است که تولید کننده ها به هر کسی که بخواهند می توانند محصول خود را
        ارئه نمایند لذا با توجه به محدودیت محصولاتی که دارند آنها عنوان شغل و مقدار و نوع محصولاتی
        که متقاضیان به دیگران ارائه داده اند را بررسی کرده و در مورد اینکه بعنوان دریافت کننده محصول
        آنها انتخاب شوند تصمیم می گیرند
      </Typography>
      <Typography>
        لذا تا زمانی که ارزشی تولید نکنید و یا محصول یا خدماتی به دیگر اعضا ارائه ننمایید شانس کمی
        برای دریافت محصولات از اعضا خواهید داشت
      </Typography>
    </Box>
  )
}
export const FirtstTabText2 = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
        👇کسب و کارهایی که به ارائه محصول به کسب و کار شما متعهد می شوند در این قسمت به نمایش در می
        آیند
      </Typography>
      <Typography sx={{ mb: 1, fontSize: 14 }}>
...
export const createBusiness_selectAsPrimary = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      <Typography>
        داشتن چند شغل و عضویت در چند کسب و کار مختلف تا سقف 3 عدد مجاز است اما محصولاتی که دریافت می
        کنید به حساب کسب و کار اصلی شما منظور می شود
      </Typography>
      <Typography>تغییر کسب و کار اصلی تنها هر 14 روز یکبار امکانپذیر است</Typography>
    </Box>
  )
}
export const AllBusinessesText = () => {
  return (
    <Box sx={{ py: 1, textAlign: 'center' }}>
      ...
      <Typography sx={{ fontSize: 14 }}>
        توجه داشته باشید موقعیت مکانی که در این صفحه مشخص می کنید جایی ذخیره نمی شود و برای محاسبه و
        نمایش نزدیکترین کسب و کارها در همین صفحه کاربرد دارد
      </Typography>
    </Box>
  )
}
