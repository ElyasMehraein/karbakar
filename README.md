...
#### لاجیک:
ساخت یک اتحاد با ثبت نیاز یک کسب و کار به مقداری مشخص از محصولات و خدمات یک صنف شروع می شود و این اعلان نیاز به نمایندگان اصناف تامین کننده به ترتیب فاصله جغرافیایی نمایش داده می شود 
