...
### صفحه اصلی
این صفحه جدای از منو ها و آیتم های بالای صفحه شامل چهار بخش می باشد  
...
* تاریخ عضویت  
> مابقی مشخصات که بصورت پیشفرض قرار میگیره و بعدا کاربر میتونه تغییر بده
...
#### لاجیک:
* کسب و کار با انتخاب صنف و نام ایجاد می شود  
* اعضای اولین کسب می توانند سایر کاربران و کسب و کارها به مدت 3 و 7 روز و دائم بن کند( افراد و کسب و کارهای بن شده در جستجو نمایش داده نمی شوند و افراد از کسب و کارهای عضو خارج می شوند و در صورتی که نفر آخر کسب و کار باشند از کسب و کار خارج نمی شوند بلکه آن کسب و کار هم بن می شود)  
...
* عکس؛ آپلود می کند
* آیدی؛ حروف انگلیسی پیوسته 20 کارکتری که در لینک صفحه استفاده می شود
* اسم؛ ۲۰ کارکتری
...
ا* طلاعات واحد تولیدی و خدماتی توسط همه قابل مشاهده و توسط نماینده قابل ویرایش است
...
> علاوه بر اطلاعات بالا که وارد می شود موارد ذیل هم در صفحه کسب و کار جهت مشاهده همگان وجود دارد  
...
### تب دریافت
لیست کسب و کارهای متقاضی قرار گرفتن در لیست دریافت کنندگان صنف های مشخص

لاجیک:
نمایندگان کسب و کارها می توانند با نوشتن توضیحات اختیاری صد کارکتری و انتخاب یک صنف جهت عضویت در لیست دریافت کنندگان کسب و کارهای آن صنف درخواست دهند
...
### تب ارائه
وقتی نماینده کسب و کار درخواستهای خود را باز می کنند می توانند آن را ویرایش و یا پاک کنند و واحد های تولیدی خدماتی که آن را تایید کرده اند را مشاهده نمایند
...
از شماره تلفن و تایید با پیامک برای ورود استفاده می شود و در ورود های بعدی خود به خود به صفحه اصلی منتقل می شود مگر اینکه خروج از حساب را انتخاب کند
توکن 1 ماه اعتبار دارد
...
دریافت کنندگان و تامین کنندگان
...
2* تامین کننده کسب و کارهایی را که دوست دارد را در پروفایلشان بر روی دکمه "افزودن به لیست دریافت کنندگان" کلیک می کند و در صورت تایید او، در لیست دریافت کنندگان قرار می گیرد
...
تعهدات اجتماعی
هر کسب و کار مقدار کالایی که می خواهد به دیگران بدهد را در بازه زمانی یک ماهه مشخص می کند
دریافت کنندگان می توانند از لیست کالاهای به اشتراک گذاشته شده تا سقف مشخص شده برای خود رزرو کنند.
در صورت عدم دریافت در طی بازه زمانی اعلام شده ظرفیت رزرو شده آزاد می شود و کسب و کارهای دیگر می توانند آن را رزرو کنند
