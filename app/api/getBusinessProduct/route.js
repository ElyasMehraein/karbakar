...
export async function GET(req) {
  try {
    ...
    return Response.json({ message: 'Get Business products successfully', data }, { status: 200 })
  } catch (error) {
    console.error(`Error getting Business products`, error)
    return Response.json({ message: `Error getting Business products`, error }, { status: 500 })
  }
}
