...
export async function POST(req) {
  try {
    ...
    await UserModel.updateOne({ _id: recepiant._id }, { $pull: { businesses: Business._id } })

    await BusinessModel.updateOne({ _id: Business._id }, { $pull: { workers: recepiant._id } })
    ...
    await UserModel.updateOne({ _id: recepiant._id }, { $pull: { primeJob: Business._id } })
